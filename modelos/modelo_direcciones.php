...
{
    $sql = "INSERT INTO address (address, address2, district, city_id, postal_code, phone, location)
            VALUE (:direccionPrincipal, :direccionSecundaria, :distrito, :ciudad, :codigoPostal, :telefono, :localisacion);";
