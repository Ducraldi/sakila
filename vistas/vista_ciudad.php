                ...
                <div class="ani animated animate__bounceInLeft col-md-5">
                    <form action="ciudad.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" placeholder="Escribe una ciudad" name="ciudadPrincipal"
                                   id="ciudadPrincipal" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <?php } else { ?>
                                <select name="selecionPais" id="selecionPais" class="custom-select">
                                    <option value="<? $selecionPais ?>">Seleccione un Pais</option>
                                    <?php
                            ...
                            <table class="table table-sm table-dark">
                                ...
                                foreach ($ciudades as $ciudad) {
                                    ...
                                    echo "<tr class=\"bg-secondary\">
                                                  ...
                                                  <td>" . ucwords(strtolower($ciudad['city'])) . "</td>
                                                  <td>{$ciudad['country']}</td>
                                                  <td>
                                                  <button class='btn btn-outline-danger btn-sm' value='{$ciudad['city_id']}' name='eliminarCiudad' title='Eliminar'><i class='fas fa-trash'></i></button>
                                                  <button class='btn btn-outline-success btn-sm' value='{$ciudad['city_id']}' name='editarCiudad' title='Editar'><i class='fas fa-edit'></i></button>
                                                  </td>
                                              </tr>";
                                }
                                ?>
